...
public class Constants {
	...
	public static final String PRODUCT_ADDED_SUCCSSFULLY = "Product Added Succssfully";
	public static final String PRODUCT_UPDATED_SUCCESSFULLY = "Product Updated Succssfully";
